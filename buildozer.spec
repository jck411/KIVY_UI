...
requirements = python3,kivy==2.3.1,https://github.com/kivymd/KivyMD/archive/master.zip,websockets==13.1,setuptools>=80.9.0,filetype,materialyoucolor,asynckivy,asyncgui,pyjnius
