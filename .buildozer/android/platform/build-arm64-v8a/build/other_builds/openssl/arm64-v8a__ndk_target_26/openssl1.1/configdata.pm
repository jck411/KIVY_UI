...
our %config = (
  ...
  CFLAGS => [ "-target aarch64-linux-android26 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=26" ],
  CPPFLAGS => [ "-DANDROID -I/home/human/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/human/AAREPOS/KIVY_UI/.buildozer/android/platform/build-arm64-v8a/build/python-installs/simplechat/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/home/human/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android26 -fomit-frame-pointer -march=armv8-a -fPIC",
  CXXFLAGS => [ "-target aarch64-linux-android26 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)aarch64-linux-android26-clang",
  minor => "1.1",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/human/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
